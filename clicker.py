    ...
    if num == 1:
        ...
        match melody:
            ...
            case "9":
                ...
                interval = 0.085
            case "10":
                sequence = ("300870082008300870082008300870082008300870082000088100883008850000881008200850000881008300860087676760085008200830084000086008700850000884008300820083232320081").strip()
                interval = 0.08
            case "11":      #############################################################################################################################################################################################################
                sequence = "6005403206500430210540032012054003000888888700865084306500430210540032012054000888300088886008888540320650043021085400832008105500888860888860056060088560600888520008886088600885608600856086008857040060100888565408883208865088100843021054034056"
                interval = 0.13
            case __:
